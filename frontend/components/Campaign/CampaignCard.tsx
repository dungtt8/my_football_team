    ...
    return (
        ...
        >
            <div className="flex items-start justify-between mb-md">
                <h3 className="text-lg font-bold text-black flex-1">{campaign.name}</h3>
            ...
            <div className="flex items-center justify-between mb-md">
                ...
                {campaign.deadline && (
                    <p className="text-caption text-gray">Hạn: {formatDate(campaign.deadline)}</p>
                )}
            </div>

            <div className="flex items-center justify-between">
                <p className="text-caption text-gray">
                    {campaign.assignments?.length ?? 0} phân công
                </p>
